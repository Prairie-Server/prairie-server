...
func TestCheckWebSocketOrigin(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			host:   "prairie.example.com",
			origin: "https://prairie.example.com",
			want:   true,
		},
		{
		...
		},
		{
			...
			host:          "origin.internal:8097",
			origin:        "https://prairie.example.test",
			forwardedHost: "prairie.example.test",
			want:          true,
		},
		{
		...
		},
		{
			...
			host:          "origin.internal:8097",
			origin:        "https://prairie.example.test",
			forwardedHost: "prairie.example.test, edge.internal",
			want:          true,
		},
		{
		...
		},
		{
			...
			host:   "prairie.example.com",
			origin: "https://prairie.example.com\x7f",
			want:   false,
		},
	}
