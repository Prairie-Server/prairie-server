...
function Step1FiltersAndPreview({
  ...
  return (
    <div className="space-y-5 pb-24">
      ...
      <div className="bg-background/95 supports-[backdrop-filter]:bg-background/70 fixed right-4 bottom-safe-3 z-40 flex items-center gap-3 rounded-2xl border px-4 py-3 shadow-xl backdrop-blur sm:right-6 lg:right-10 xl:right-12">
