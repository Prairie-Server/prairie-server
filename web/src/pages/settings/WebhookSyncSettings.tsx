  ...
  return (
    <div className="space-y-6 pb-6">
      ...
      <SettingsGroup
        ...
        description="Create a provider-specific webhook endpoint and choose the default Prairie profile."
      >
                                ...
                                items: [
                                  {
                                    ...
                                    note: "Prairie only records completion, not in-progress state.",
                                  },
                                ],
                              },
                            ]}
