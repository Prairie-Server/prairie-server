...
export default function SettingsOverview() {
  ...
  const attentionTiles = tiles.filter(
    (tile) => tile.state === "warn" || tile.state === "off",
  );
    ...
    <div className="w-full space-y-10">
      <header className="max-w-3xl space-y-3">
        ...
        <p className="text-muted-foreground text-sm leading-relaxed sm:text-base">
          Configure the server, media processing, integrations, and the defaults
          your household starts with.
        </p>
      </header>
      ...
      <section aria-labelledby="setup-health-heading" className="space-y-4">
        <div className="space-y-1.5">
          ...
          <p className="text-muted-foreground text-sm">
            Recommendations and configuration problems that may limit server
            features.
          </p>
        </div>
        {isLoading ? (
          ...
          <div className="border-border/60 bg-card/35 inline-flex max-w-xl items-start gap-3 rounded-xl border px-4 py-3">
            ...
            <div className="space-y-0.5">
              ...
              <p className="text-muted-foreground text-xs leading-relaxed">
                Missing setup, unavailable services, and restart-required
