...
export const SETTING_DEFINITIONS: Record<SettingKey, SettingDefinition> = {
  "catalog.metadata_language": {
    ...
    description:
      "Fallback language Silo prefers for titles, descriptions, and artwork.",
    category: "catalog",
    control: "select",
  ...
  "catalog.metadata_language_overrides": {
    ...
    description:
      "Preferred metadata language for items in specific original languages.",
    category: "catalog",
    control: "panel",
  },
  ...
  "downloads.keep_watched": {
    ...
    description:
      "Do not suggest reclaiming space from downloads you have finished.",
    category: "downloads",
    control: "switch",
    platforms: ["ios", "android"],
  },
  ...
  "nav.shortcuts": {
    ...
    description:
      "Libraries, sections, and collections pinned for use across navigation surfaces.",
    category: "navigation",
  },
  "nav.show_audiobooks": {
  ...
  "playback.auto_skip_credits": {
    ...
    description:
      "Move through end credits automatically when a skip is available.",
    category: "playback",
    control: "switch",
  },
  ...
  "playback.auto_skip_recap": {
    ...
    description:
      'Skip "previously on" recaps automatically when Silo can detect them.',
    category: "playback",
    control: "switch",
  },
  ...
  "playback.next_up_prompt_seconds": {
    ...
    description:
      "How long before the end of an episode the next-up prompt appears.",
    category: "playback",
    control: "slider",
    unit: "seconds",
    minimum: 0,
  ...
  "playback.show_forced_subtitles": {
    ...
    description:
      "Show subtitles for foreign-language dialogue even when subtitles are off.",
    category: "playback",
    control: "switch",
  },
  ...
  "player.audio_sync_ms": {
    ...
    description:
      "Shift audio earlier or later to correct lip sync on this device.",
    category: "player",
    control: "slider",
    unit: "milliseconds",
    platforms: ["ios", "tvos", "macos", "android", "android_tv"],
  ...
  "player.dv_profile7_hdr10_fallback": {
    ...
    description:
      "Play Profile 7 sources as HDR10 when this device cannot decode them natively.",
    category: "player",
    control: "switch",
    platforms: ["ios", "tvos", "macos", "android", "android_tv"],
  },
  ...
  "player.sleep_timer_default_minutes": {
    ...
    description:
      "Duration the sleep timer starts on when you turn it on. 0 leaves it off.",
    category: "player",
    control: "stepper",
    unit: "minutes",
    minimum: 0,
  ...
  "ui.next_up_mode": {
    ...
    description:
      "Whether upcoming episodes stay with Continue Watching or get their own row.",
    category: "navigation",
    control: "select",
    values: [
