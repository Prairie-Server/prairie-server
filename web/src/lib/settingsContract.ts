...
export const SETTING_DEFINITIONS: Record<SettingKey, SettingDefinition> = {
  "catalog.metadata_language": {
    ...
    description: "Language Prairie prefers for titles, descriptions, and artwork.",
    category: "catalog",
    control: "select",
  ...
  "playback.max_bitrate_kbps": {
    ...
    description:
      "Cap how much bandwidth playback may use. No cap means Prairie picks for the chosen resolution.",
    category: "playback",
    control: "select",
    unit: "kbps",
    minimum: 100,
  ...
  "playback.preferred_quality": {
    ...
    description: "Pick the quality Prairie should prefer.",
    category: "playback",
    control: "select",
    values: [
  ...
  "player.passout_threshold": {
    ...
    description:
      "How many episodes auto-play before Prairie asks whether you are still watching. 0 never asks.",
    category: "player",
    control: "stepper",
    unit: "episodes",
    minimum: 0,
  ...
  "ui.theme": {
    ...
    label: "Theme",
    description: "Color theme for the Prairie interface.",
    category: "appearance",
    control: "select",
    values: [
