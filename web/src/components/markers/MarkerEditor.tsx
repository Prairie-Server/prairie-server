...
function fieldsFromResponse(data: FileMarkersResponse): FieldState {
  return {
    intro: {
      start: formatClock(data.intro.start),
      end: formatClock(data.intro.end),
    },
    recap: {
      start: formatClock(data.recap.start),
      end: formatClock(data.recap.end),
    },
    credits: {
      start: formatClock(data.credits.start),
      end: formatClock(data.credits.end),
    },
    preview: {
      start: formatClock(data.preview.start),
      end: formatClock(data.preview.end),
    },
  };
}
...
export function MarkerEditor({
  ...
  const history = useItemMarkerHistory(itemId, {
