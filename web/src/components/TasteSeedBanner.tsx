...
export default function TasteSeedBanner() {
  ...
  return (
    <div className="px-4 sm:px-6 lg:px-10 xl:px-12">
      <div className="surface-panel relative flex flex-col items-start gap-3 rounded-[1.4rem] border-0 px-5 py-4 sm:flex-row sm:items-center sm:gap-4 sm:px-6 lg:pr-24">
